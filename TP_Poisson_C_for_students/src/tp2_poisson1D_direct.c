...
/* ** argv: Values of arguments */
{
 ...
 pài ipiv = (int *) calloc(la, sizeof(int));
  ...
  if (row == 1){ // LAPACK_ROW_MAJOR
    ...
    LAPACKE_dgbmv(LAPACK_ROW_MAJOR,'N', la, lab, kl, ku,  ALPHA=1, AB, la, X, INCX=1, BETA=-1, Y, INCY=1);
    ...
    LAPACKE_dgbmv(LAPACK_COL_MAJOR,'N', la, lab, kl, ku,  ALPHA=1, AB, la, X, INCX=1, BETA=-1, Y, INCY=1);
